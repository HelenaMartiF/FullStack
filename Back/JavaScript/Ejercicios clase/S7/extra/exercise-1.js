...
const letsFindThem = videogames.filter(basurero => basurero.genders.includes('RPG'));

const sumaScore = letsFindThem.reduce((basurero, score) => basurero + score.score, 0);

const mediaScore = sumaScore / letsFindThem.length;
