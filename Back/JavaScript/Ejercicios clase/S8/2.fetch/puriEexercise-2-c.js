...
function print(valorIntroducido) {
  ...
  for (const objArray of valorIntroducido) {
    ...
    div.appendChild(p); //div.appendChild(p). Esto asegura que el botón esté dentro del párrafo y que el párrafo esté dentro del contenedor <div> en el documento HTML.
  }
}
